...
export const ALLARGS = {
    version: {
        arg: "version",
        conf: "autoBuildOpencvVersion",
        env: "OPENCV4NODEJS_AUTOBUILD_OPENCV_VERSION",
        isBool: false,
        doc: "OpenCV version",
    },
    verbose: { arg: "verbose", isBool: false, doc: "verbose" },
    flags: {
        arg: "flags",
        conf: "autoBuildFlags",
        env: "OPENCV4NODEJS_AUTOBUILD_FLAGS",
        isBool: false,
        doc: "OpenCV cMake Build flags",
    },
    root: {
        arg: "root",
        conf: "rootcwd",
        env: "INIT_CWD",
        isBool: false,
        doc: "OpenCV-build root directory (deprecated)",
    },
    prebuild: {
        arg: "prebuild",
        conf: "prebuild",
        env: "OPENCV_PREBUILD",
        isBool: false,
        doc: "force prebuild param: latestBuild|latestVersion|oldestBuild|oldestVersion",
    },
    buildRoot: {
        arg: "buildRoot",
        conf: "buildRoot",
        env: "OPENCV_BUILD_ROOT",
        isBool: false,
        doc: "OpenCV build directory",
    },
    cuda: {
        arg: "cuda",
        conf: "autoBuildBuildCuda",
        env: "OPENCV4NODEJS_BUILD_CUDA",
        isBool: true,
        doc: "Enable cuda in OpenCV build",
    },
    // add on 28/12/2022
    cudaArch: {
        arg: "cudaArch",
        ...
        isBool: false,
        doc: "Specify the cuda arch will drasticly reduce build time, see https://en.wikipedia.org/wiki/CUDA, ex if you have a RTX 3080 use --cudaArch=8.6, if you have also a RTX 2080 --cudaArch=7.5,8.6",
    },
    nocontrib: {
        arg: "nocontrib",
        conf: "autoBuildWithoutContrib",
        env: "OPENCV4NODEJS_AUTOBUILD_WITHOUT_CONTRIB",
        isBool: true,
        doc: "Do not compile Contrib modules",
    },
    nobuild: {
        arg: "nobuild",
    ...
    binDir: {
        ...
        env: "OPENCV_BIN_DIR",
        isBool: false,
        doc: "OpenCV bin directory",
    },
    keepsources: {
        arg: "keepsources",
        conf: "keepsources",
        isBool: true,
        doc: "Keepsources OpenCV source after build",
    },
    "dry-run": {
        arg: "dry-run",
        conf: "dry-run",
        isBool: true,
        doc: "Display command line use to build library",
    },
    "git-cache": {
        arg: "git-cache",
        conf: "git-cache",
